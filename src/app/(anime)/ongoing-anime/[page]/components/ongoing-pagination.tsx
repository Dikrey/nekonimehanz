    ...
    <Pagination className="mt-8">
      <PaginationContent className="flex flex-wrap items-center justify-center gap-2">
        ...
        <PaginationItem>
          {prevPageEnabled ? (
            <PaginationPrevious
              href={`/ongoing-anime/${current_page - 1}`}
        ...
        {visiblePages[0] > 1 && (
          <>
            <PaginationItem>
              <PaginationLink href="/ongoing-anime/1">1</PaginationLink>
            </PaginationItem>
            {visiblePages[0] > 2 && (
              <PaginationItem>
                <PaginationEllipsis />
        ...
        {visiblePages[visiblePages.length - 1] < totalPages && (
          <>
            ...
            <PaginationItem>
              <PaginationLink href={`/ongoing-anime/${totalPages}`}>
                {totalPages}
              </PaginationLink>
            </PaginationItem>
          </>
        ...
        <PaginationItem className="sm:hidden">
          <DropdownMenu>
            ...
            >
              <DropdownMenuLabel className="text-center text-sm font-semibold text-muted-foreground">
                Go to Page
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
              <div className="grid grid-cols-4 gap-2 pt-2">
                {Array.from({ length: totalPages }, (_, i) => {
                  const page = i + 1;
                  return (
                    <Link key={page} href={`/ongoing-anime/${page}`}>
                      <DropdownMenuItem
